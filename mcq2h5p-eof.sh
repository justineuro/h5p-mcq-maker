...
#####
# set color tags (not all needed) to be used for emphases
####
BLACK='\e[1;30m'
RED='\e[1;31m'
GREEN='\e[1;32m'
...
#							 but this doesn't have to be set)
#
#####
...
echo -e "\nReading `expr ${n_blanks} + 1`st question ..."
while read line; do
...
EOT
		...
		n_blanks=`expr $n_blanks + 1` # increment . of blank lines
